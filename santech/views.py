...
def home(request):
    ...
    return render(request, 'santech/home.html', data)
...
def blog(request):
    ...
    data.update(template_dict)
    return render(request, 'santech/blog.html', data)
...
def blog_article(request, article):
    ...
    data.update(template_dict)
    return render(request, 'santech/blog_article.html', data)


def contacts(request):
    # office = Office.objects.all()[0]
    # office_mail = office.email
    server_mail = 'ooo.santech-montage@yandex.ru'
    data = {
        'form': MailForm(),
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            data['form'] = form
    return render(request, 'santech/contacts.html', data)
...
def pricing(request):
    ...
    data.update(template_dict)
    return render(request, 'santech/pricing.html', data)
...
def reviews(request):
    ...
    return render(request, 'santech/reviews.html', data)
...
def services(request):
    ...
    data.update(template_dict)
    return render(request, 'santech/services.html', data)
...
def services_article(request, article):
    ...
    data.update(template_dict)
    return render(request, 'santech/services_article.html', data)
...
def workers(request):
    ...
    data.update(template_dict)
    return render(request, 'santech/workers.html', data)